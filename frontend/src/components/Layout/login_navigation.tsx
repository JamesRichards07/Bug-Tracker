        ...
        <header>
            <nav className="fixed relative flex inset-x-0 top-0 bg-gray-200 text-white z-10 p-3">
                ...
                <ul className='absolute flex text-black right-0 space-x-10 pr-7'> 
                    <li>
                        <Link className='text-center item-center' to="/login">Login</Link>
                    </li>
                    <li>
                        <Link className='bg-green-600 px-2 py-1 text-white rounded-full h-9 w-9 text-center' to="/signup">Sign Up</Link>
                    </li>
                </ul>
            </nav>
        </header>
